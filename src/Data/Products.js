    ...
    subProduct: [
      ...
      // TOUCH-SAFE HEATER
      {
        ...
        productImg: async () =>
          (
            await import(
              "../assets/ptoductsImg/touch-safe-heater/img (1).png"
            )
          ).default,
        application: "",
        models: ["SCSF 060 (50W to 150W)"],
        featuresH: "Features",
        features: [
          "Low surface Temperature ",
          "Quick Mounting ",
          "Double Insulated (plastic)",
          "Wide voltage range",
          "Small size "
        ],
        description:
          "SAIEGO Touch-safe heater for the use in enclosures with electrical/electronical components.The design of the heater supports the natural convection which results in a high air- current of warm air.The surface temperatures on the accessible side surfaces of the housing are kept down as a result of the heater design.Our complete range of thermostats and hygrostats can directly be connected to the heater SCS 060.This heater is also available in a version with plug -in thermostat requiring no additional wiring(SCSF 060).The heaters are designed for permanent operation.",
        workingH: "Working Principle & Features",
        workingDetails: [
        ],
        tests: [],
        ...
        otherImages: [
          {
            ...
            images: [
              async () =>
                (
                  await import(
                    "../assets/ptoductsImg/touch-safe-heater/img (2).png"
                  )
                ).default,
              async () =>
                (
                  await import(
                    "../assets/ptoductsImg/touch-safe-heater/img (6).png"
                  )
                ).default,
...

          {
            ...
            images: [
              async () =>
                (
                  await import(
                    "../assets/ptoductsImg/touch-safe-heater/img (3).png"
                  )
                ).default,
            ],
          },

          {
            ...
            images: [
              async () =>
                (
                  await import(
                    "../assets/ptoductsImg/touch-safe-heater/img (5).png"
                  )
                ).default,
          ...
          {
            heading: "Temperature diagram",
            images: [
              async () =>
                (
                  await import(
                    "../assets/ptoductsImg/touch-safe-heater/img (4).png"
                  )
                ).default,
