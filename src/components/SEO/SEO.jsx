...
import defaultImage from "../../assets/hompage-cardimgs/1.png"; // Fallback image
import defaultLogo from "../../assets/hompage-cardimgs/2.png"; // Fallback logo
...
const SEO = ({
  ...
  email = ["sales@saiego.com", "info@saiego.com"], // Emails added
  address = {
  ...
  const organizationSchema = {
    ...
    address: {
      ...
      email: email,
      sameAs: [
        // "https://www.linkedin.com/company/saiego",
        // "https://twitter.com/saiego",
      ],
    },
